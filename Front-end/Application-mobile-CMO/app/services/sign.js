...
async function signEmployeur(employeur) {
  try {
    const response = await fetch(url() + "signup/employeur", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    console.error("Error signing up employeur:", error);
...
export { signCandidat, signEmployeur };